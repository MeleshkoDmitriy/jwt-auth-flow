...
export default function AdminScreen() {
  const adminActions = [
    { icon: 'users' as const, title: 'Manage Users', count: 156, color: '#007AFF' },
    { icon: 'cog' as const, title: 'System Settings', count: 12, color: '#28a745' },
    { icon: 'database' as const, title: 'Database', count: 8, color: '#ffc107' },
